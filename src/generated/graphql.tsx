...
export type MissionInfoQuery = { __typename?: 'Query', launches?: Maybe<Array<Maybe<{ __typename?: 'Launch', mission_name?: Maybe<string>, mission_id?: Maybe<Array<Maybe<string>>>, launch_year?: Maybe<number> }>>> };
...
export function useMissionInfoQuery(baseOptions?: Apollo.QueryHookOptions<MissionInfoQuery, MissionInfoQueryVariables>) {
        ...
        return Apollo.useQuery<MissionInfoQuery, MissionInfoQueryVariables>(MissionInfoDocument, options);
      }
export function useMissionInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MissionInfoQuery, MissionInfoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MissionInfoQuery, MissionInfoQueryVariables>(MissionInfoDocument, options);
        }
